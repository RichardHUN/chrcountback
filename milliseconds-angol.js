	...
	english.onclick = function(){
		window.open("./milliseconds-angol.html", "_self");
	}
	magyar.onclick = function(){
		window.open("./milliseconds.html", "_self");
	}
		function frissit(){
		...
		maradek.day *= 1000;
		maradek.day -= most.getMilliseconds();

		let newYear = most.getDate() - 31;
		if(most.getMonth() == 11 && most.getDate() >= 24){
			maradek.day = 365*24*60*60*1000 + newYear*24*60*60*1000 - most.getMilliseconds();
		}

		switch(angol){
			case 0:
				document.getElementById("write").innerHTML = "Karácsonyig " + maradek.day + " milliszekundum van hátra hátra.";
				if(GUI%2!=0){
						...
						document.getElementById("top").innerHTML = "Váltás másodpercekre";
					}else {
			...
			case 1:
				if(maradek.day>1)
					document.getElementById("write").innerHTML = "There are " + maradek.day + " milliseconds until Christmas.";
				if(maradek.day==1)
					document.getElementById("write").innerHTML = "There is " + maradek.day + " millisecond until Christmas.";
				if(GUI%2!=0){
						...
						document.getElementById("top").innerHTML = "Change to seconds";
					}else {
						document.getElementById("down").innerHTML = "";
						document.getElementById("middledown").innerHTML = "";
						document.getElementById("middle").innerHTML = "";
		...
		var reset = setInterval(frissit, 1)